...
<script>
  export default {
    name: 'card',
    props: ['img', 'title', 'desc', 'category', 'tag', 'viewCount', '_id', 'like', 'createdAt'],
    computed: {
      time() {
        if (this.createdAt) {
...
<style>
  ...
  #home-card {
    ...
    box-shadow: 0 0 1px 1px rgba(121, 121, 121, .16);
  }

  #home-card:hover {
    box-shadow: 1px 1px 1px 2px rgba(121, 121, 121, .16);
  }
